 ...
 * @param {object} [extraHeaders] — headers extras (ex: { Range: '0-999' } pra paginação).
 *   Opcional e retrocompatível — chamadas existentes com 3 args continuam iguais.
 * @returns {Promise<any[]>}    — array de linhas parsed
 */
function supabaseGet(supabaseUrl, supabaseKey, endpoint, extraHeaders = {}) {
