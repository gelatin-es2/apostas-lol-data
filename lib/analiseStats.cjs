...
// Fonte: dashboard/index.html linhas 1719-2001.
// ATENÇÃO: toda mudança em getBetSimulation() ou aggBy() no HTML deve ser replicada aqui.
// Sem isso, briefing e dashboard divergem (bug detectado 2026-05-28: Galions 50% vs 69%).
//
