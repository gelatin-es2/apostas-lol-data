...
// api/lib/finance-categories.cjs têm conteúdo idêntico (teste de paridade em
...
export const FINANCE_CATEGORY_SLUGS = Object.freeze(FINANCE_CATEGORIES.map((category) => category.slug));
...
export const AUTO_IGNORE_CATEGORIES = Object.freeze(['pagamento_fatura']);

export function isFinanceCategory(slug) {
  return typeof slug === 'string' && FINANCE_CATEGORY_SLUGS.includes(slug);
}

export function financeCategoryLabel(slug) {
